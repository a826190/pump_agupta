...
# Primary Options
parser.add_argument("-o", "--organization", required=False, default="vrvzh6")
parser.add_argument("-T", "--typeId", required=False, default="pump_co")
parser.add_argument("-I", "--deviceId", required=False, default=str("111137F8"))
parser.add_argument("-t", "--token", required=False, default="gPD-JSeZpZKGJ382vl", help="gPD-JSeZpZKGJ382vl")
...
parser.add_argument("-D", "--delay", required=False, type=float, default=60, help="number of seconds between msgs")
...
for x in range(0, args.nummsgs):
    ...
    data = {'speed': 1121, 'head': 54.321, 'pump_mode': 'a', 'flow': 115.939, 'voltage': 274, 'POWER': 2.667, 'CURRENT': 8.68}
